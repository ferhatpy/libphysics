...
class sets:
    ...
    flow = [{100:"get_formulary", 150:"get_subformulary",
             200:"", 300:"diffration_rectangular",
             400:""}[i] 
            for i in [300]]

### Formulary
print("Test of the {0} class.".format(sets.flow[0]))
...
if "diffration_rectangular" in sets.flow:
    ...
    oopti.class_type = {1:"Rayleigh_Sommerfeld", 2:"Fraunhofer", 3:"Fresnel"}[3]
    oopti.__init__()
    oopti.solver.verbose = False
...
#    commands = ["xreplace", "oopti.Fraunhofer", xreplaces]
#    oopti.process(commands)
