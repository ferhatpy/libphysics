...
from typing import Any, List, Callable, Union, Optional, Dict, Tuple
try:
    from libphysics import libsympy
except ImportError:
    import libsympy
import sys
...
class solver:
    ...
    def get_codes(self) -> List[Any]:
        return self.codes

    def process(self, commands: List[Any], classname: str) -> Any:
...
#        return(self.result)
    ...
    def get_codes(self) -> List[Any]:  # todo
        return self.codes

    def get_formulary(self, style: str = "name-eq", verbose: bool = True, **kwargs: Any) -> List[Any]:
        """
...
#                All functions in a branch must be callable with default parameters.
    ...
    def get_subformulary(self, style: str = "name-eq", verbose: bool = True) -> List[Any]:
        """
    ...
    def process(self, commands: List[Any]) -> Any:
        """
        Structure
        =========
