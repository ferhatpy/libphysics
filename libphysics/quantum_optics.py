...
"""
from sympy import*
from libphysics.libreflection import *
...
class quantum_optics(branch):
    """

    """
    _name = "quantum_optics"
    ...
    def __init__(self, class_type='default'):
        ...
        # File settings
        self.input_dir  = "input/quantum_optics"
        self.output_dir = "output/quantum_optics"
